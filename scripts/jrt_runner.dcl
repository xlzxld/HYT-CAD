jrt_param : dialog {
  ...
  : boxed_column {
    ...
    : row {
      : edit_box { key = "jrt2_hook_ext"; label = "出线口通道延伸:"; edit_width = 10; }
...
jrt_template_select : dialog {
  ...
  : boxed_radio_column {
    ...
    : radio_button { key = "tpl1"; label = "通用二 — JRT外壁整圈+JRTDW标记出线口→内偏恒朝轮廓内侧(几何判定,与JRTDW画向无关); 颈线恒朝FLB外侧不入侵; 圆弧壁通道线自动延伸"; }
  }
  : row {
