...
;; 与 offset_runner / slot_runner 的参数表相互独立, 同时加载互不影响。
;; ============================================================================
...
;; ============================================================================
;; 一、工具函数(与主脚本 offset_runner v9.5 逐字一致)
;; ============================================================================
;; 计算两点距离
(defun dt:dist (p1 p2)
...
;; slot_runner 的 dt:cut-curve 默认图层不同, 三脚本同时加载时避免互相覆盖)
;; ============================================================================
...
;; (与 offset_runner 逐字一致; v9.14 供 cross-points 包围盒预过滤用)
...
;; slot_runner 的 dt:fillet-pair 多一个 nochk 第7参, 三脚本同时加载时
;; 6/7 参定义互相覆盖会报参数数量错误)
;; ============================================================================
