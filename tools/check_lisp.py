...
CX = [n for n in COMMON if n != 'dt:fillet-pair'] + \
       ...
       ['c:CX', 'c:CXPARAM', 'c:SLOT', 'c:SLOTPARAM', 'dt:cx-param-dialog',
        ...
        'dt:cx-yxb', 'dt:cx-yxb-plan', 'dt:cx-yxb-place',
         'dt:cx-yxb-find-walls', 'dt:cx-yxb-segs-of',
         'dt:cx-yxb-draw',
...
JRT = JRT_COMMON + ['c:JRT', 'c:JRTPARAM', 'dt:jrt-param-dialog',
                ...
                'dt:jrt-apply-template', 'dt:jrt-tpl-keys',
                 ...
                 'dt:jrt2-pick-near', 'dt:jrt2-layer',
                 'dt:jrt2-curve-edges', 'dt:jrt2-region-edges',
                 'dt:jrt2-pt-inside', 'dt:jrt2-mid-pt', 'dt:jrt2-curve-len',
                 'dt:jrt2-pick-side', 'dt:jrt2-samples',
                 'dt:jrt2-pt-curves-dist', 'dt:jrt2-flb-score',
                 'dt:jrt2-propagate', 'dt:jrt2-line-extend',
                 'dt:jrt2-region-edges-n', 'dt:jrt2-out-end',
                 'dt:jrt2-seg-rebuild',
                 'dt:jrt2-free-ends',
